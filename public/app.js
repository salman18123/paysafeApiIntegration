...
myapp.controller('paymentcontroller',['$location','$http',function($location,$http){  
 ...
 this.checkout=function(){
    ...
    (async () => {
        ...
        paysafe.checkout.setup("cHVibGljLTc3NTE6Qi1xYTItMC01ZjAzMWNiZS0wLTMwMmQwMjE1MDA4OTBlZjI2MjI5NjU2M2FjY2QxY2I0YWFiNzkwMzIzZDJmZDU3MGQzMDIxNDUxMGJjZGFjZGFhNGYwM2Y1OTQ3N2VlZjEzZjJhZjVhZDEzZTMwNDQ=", input, function(instance, error, result) {
            ...
            // $http.get('/api/customers/'+main.customerId)
            // .then((response)=>{
            //     console.log(response)
            //     if(response.data=='NO_RECORD_EXISTS'){}
            // })
